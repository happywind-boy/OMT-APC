...
% Precompute the 3d unit vectors making up each facet's edges in the XY plane.
...
if ~options.griddedInput            % SCATTERED QUERY POINTS
    ...
    % unpack/reshape this 3d mask to a full 3D logical mask
...
% 3d mask and must be reshaped to [LEN(Y) LEN(X) LEN(Z)].
IN = reshapeINfcn(IN);
